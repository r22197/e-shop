...
public interface CategoryService {
    Category create(CategoryRequest request) throws CategoryNotFoundException, InfiniteLoopException;
    Category read(Long categoryId) throws CategoryNotFoundException;
    Category update(CategoryRequest request) throws CategoryNotFoundException, InfiniteLoopException;
